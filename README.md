...
<head>
    ...
    <style>
        ...
        * {
        ...
        .flow-legend .legend-item.hidden::after {
...
<body>
    ...
    <div class="container">
        ...
        <section class="chart-section">
            ...
            <div class="legend-container flow-legend">
                <div class="legend-item" data-type="visualImpact">
                    <div class="legend-color" style="background-color: var(--visual);"></div>
                    <span>视觉冲击</span>
                </div>
                <div class="legend-item" data-type="emotionalResonance">
                    <div class="legend-color" style="background-color: var(--emotion);"></div>
                    <span>情感共鸣</span>
                </div>
                <div class="legend-item" data-type="decisionPressure">
                    <div class="legend-color" style="background-color: var(--decision);"></div>
                    <span>决策压力</span>
                </div>
                <div class="legend-item" data-type="feedbackIntensity">
    ...
    <script>
        ...
        function createLotusPond() {
            ...
            const lotusCount = 12; // 增加荷花数量
            const leafCount = 15; // 增加荷叶数量
            ...
            { 
                ...
                keyPoints: [
                    ...
                    },
                    {
                        ...
                        details: '曲红绡逗弄玩家说几人都是她杀的，模糊真相，玩家见招拆招，获得曲红绡的认可和合作邀约。'
                    },
                    {
                        title: '暧昧氛围营造',
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const visualColor = rootStyles.getPropertyValue('--visual').trim();
            const emotionColor = rootStyles.getPropertyValue('--emotion').trim();
            const decisionColor = rootStyles.getPropertyValue('--decision').trim();
            const feedbackColor = rootStyles.getPropertyValue('--feedback').trim();
            
            // 转换为RGBA格式
            const visualBg = hexToRGBA(visualColor, 0.2);
            const emotionBg = hexToRGBA(emotionColor, 0.2);
            const decisionBg = hexToRGBA(decisionColor, 0.2);
            const feedbackBg = hexToRGBA(feedbackColor, 0.2);
            ...
            // 为心流图例项添加切换功能
            document.querySelectorAll('.flow-legend .legend-item').forEach(item => {
                ...
                function toggleVisibility() {
                    ...
                    // 切换状态
                    isVisible = !isVisible;
                    heartFlowChart.setDatasetVisibility(datasetIndex, isVisible);
            ...
            // 为图例添加点击事件
            document.querySelectorAll('.legend-container:not(.flow-legend) .legend-item').forEach(item => {
